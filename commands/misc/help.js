...
**Economy**
\`apply\` **,** \`balance\` **,** \`buy\` **,** \`daily\` **,** \`equip\` **,** \`joblist\` **,** \`profile\` **,** \`work\` **,** \`beg\` **,** \`withdraw\` **,** \`deposit\` **,** \`shop\` **,** \`use\` **,** \`inventory\` **,** \`multipliers\` **,** \`slot\` **,** \`sell\` **,** \`pay\` **,** \`collect\` **,** \`open\` **,** \`exchange\`

**Pickaxe**
\`ores\` **,** \`mine\` **,** \`pickaxe\` **,** \`pickaxe upgrade\` **,** \`pickaxe recharge\` **,** \`pickaxe stats\` **,** \`pickaxe list\`

**Utility**
\`invite\` **,** \`help\` **,** \`message\` **,** \`cmdsettings\` **,** \`prefix\` **,** \`avatar\` **,** \`clear\`
